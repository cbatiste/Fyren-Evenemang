...
export default function PageLogo() {
  return (
    <motion.div className={"flex flex-row self-center pt-6 select-none"} initial={{opacity: 0}}
      ...
      <h3 className={"py-12 pr-4 sm:pr-6 sm:py-20 sm:px-10 text-2xl sm:text-3xl"}>FYREN</h3>
      ...
      <h3 className={"py-12 pl-4 sm:pl-6 sm:py-20 sm:px-10 text-2xl sm:text-3xl"}>ONLINE</h3>
    </motion.div>
  );
}